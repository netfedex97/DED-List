                    ...
                    <template v-if="levels.length > 0">
                        ...
                        <div class="level" v-for="(level, i) in levels.slice(0, progression.length)">
                            ...
                            <div class="meta">
                                ...
                                <h2><a class="director" :href="'/#/level/' + level.path" target="_blank">{{ level.name }}</a></h2>
                                <div>
                        ...
                        <div class="level" v-if="!hasCompleted">
                            ...
                            <div class="meta">
                                ...
                                <h2><a class="director" :href="'/#/level/' + currentLevel.path" target="_blank">{{ currentLevel.name }}</a></h2>
                                <div>
                                    <div style="display: inline-block; width: 50%;">
