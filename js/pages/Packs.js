            ...
            <div class="level-container">
                ...
                <div class="level" v-else-if="selected !== null && selectedPackIndex !== null && selectedPack.levels">
                    <div class="copy-container">
                        ...
                        <Copy v-if="!copied" @click="copyURL('/#/level/' + level.path); copied = true"></Copy>
                        <Copied v-if="copied" @click="copyURL('/#/level/' + level.path); copied = true"></Copied>
                    </div>
                ...
                <div class="copy-container">
                    ...
                    <Copy v-if="!copied" @click="copyURL('/#/packs/pack/' + selectedPack.name.toLowerCase().replaceAll(' ', '_')); copied = true"></Copy>
                    <Copied v-if="copied" @click="copyURL('/#/packs/pack/' + selectedPack.name.toLowerCase().replaceAll(' ', '_')); copied = true"></Copied>
                </div>
                    ...
                    <p v-if="selectedPack.levels" class="type-body">
                        <template v-for="(level, index) in selectedPack.levels">
                            <a class="director" :href="'/#/level/' + level.path">{{ level.name }}</a>
                    ...
                    <div class="pack-records">
                        <p v-for="record in selectedPack.records">
                            <a class="director" :href="'/#/leaderboard/user/' + record.toLowerCase().replaceAll(' ', '_')">{{ record }}</a>
                        </p>
                    </div>
                </div>
                <!-- whatever this is -->
