        ...
        <main v-else class="page-list">
            ...
            <div class="level-container">
                ...
                <div class="copy-container">
                    ...
                    <Copy v-if="!copied" @click="copyURL('https://deadextremes.pages.dev/#/packs/pack/' + selectedPack.name.toLowerCase().replaceAll(' ', '_')); copied = true"></Copy>
                    <Copied v-if="copied" @click="copyURL('https://deadextremes.pages.dev/#/packs/pack/' + selectedPack.name.toLowerCase().replaceAll(' ', '_')); copied = true"></Copied>
                </div>
                    ...
                    <p v-if="selectedPack.levels" class="type-body">
                        <template v-for="(level, index) in selectedPack.levels">
                            <a class="director" :href="'https://deadextremes.pages.dev/#/level/' + level.path">{{ level.name }}</a>
                    ...
                    <div class="pack-records">
                        <p v-for="record in selectedPack.records">
                            <a class="director" :href="'https://deadextremes.pages.dev/#/leaderboard/user/' + record.toLowerCase().replaceAll(' ', '_')">{{ record }}</a>
                        </p>
                    </div>
                </div>
                <!-- whatever this is -->
